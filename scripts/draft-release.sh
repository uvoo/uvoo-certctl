...
shopt -s nullglob
assets=(
  "$DIST_DIR"/uvoo-certctl_"$VERSION"_*.tar.gz
  "$DIST_DIR"/uvoo-certctl_"$VERSION"_*.zip
  "$DIST_DIR"/uvoo-certctl_"$VERSION"_*.tar.gz.sha256
  "$DIST_DIR"/uvoo-certctl_"$VERSION"_*.zip.sha256
)
