...
func init() {
	...
	cmd := &cobra.Command{
		...
		Example: `  uvoo-certctl disable-auth-issuer --issuer https://sso.example.com/realms/uvoo-certctl
  uvoo-certctl disable-auth-issuer --issuer https://sso.example.com/realms/uvoo-certctl --json`,
