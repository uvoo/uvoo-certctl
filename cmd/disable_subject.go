...
func init() {
	...
	cmd := &cobra.Command{
		...
		Example: `  uvoo-certctl disable-subject --issuer https://sso.example.com/realms/uvoo-certctl --subject user-123
  uvoo-certctl disable-subject --issuer https://sso.example.com/realms/uvoo-certctl --subject user-123 --json`,
